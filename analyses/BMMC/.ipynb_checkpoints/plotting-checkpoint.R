...
pdf(paste0("../../data/BMMC/plots/TFBSHeatmap/region_", regionInd, "_model_I_TFBSHeatmap.pdf"),
    width = 6, height = 5)
# Load TFBS prediction model
...
pdf(paste0("../../data/BMMC/plots/TFBSHeatmap/region_", regionInd, "_model_II_TFBSHeatmap.pdf"),
    width = 6, height = 5)
# Load TFBS prediction model
h5Path <- "../../data/TFBSPrediction/TFBS_model.h5"
TFBindingModel(project) <- loadTFBSModel(h5Path)
...
pdf(paste0("../../data/BMMC/plots/nucleosoemHeatmap/region_", regionInd, "_nucHeatmap.pdf"),
    width = 6, height = 5)
